...
\item Note, though, that the solution is invariant under in-unison
  ...
  indeed the general solution to the problem.\footnote{It is also, as
    ...
    the cascade is ‘quantum’! There is actually no special quality
    associated with ‘quantum’ physics. ‘Quantum mechanics’ refers to a
    patchwork amalgamation of methods for solving physics
    problems. Here we solved the same problem by other, in this case
    better means.}~$\square$
